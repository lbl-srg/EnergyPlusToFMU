 ...
 *
 * Author: Adrian Tirea (FMI 2.0)
 * Contributor Thierry S. Nouidui (FMI 3.0)
 * ---------------------------------------------------------------------------*/

#include "fmu30/XmlParser.h"
#include <utility>
#include <vector>
#include <string.h>
#include "fmu30/XmlElement.h"
#include "fmu30/XmlParserException.h"
...
ModelDescription *XmlParser::validate(ModelDescription *md) {
    ...
    if (!(md->getAttributeValue(XmlParser::att_fmiVersion)
        ...
        && md->getAttributeValue(XmlParser::att_instantiationToken))) {
